<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="h-[8vh] mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                {{-- <div class="shrink-0">
                    <img class="size-8" src="https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/p3/102/2024/08/15/1000002224-2315964640.jpg" alt="Your Company">
                </div> --}}
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/sejarahs" :active="request()->is('sejarahs')">Sejarah</x-nav-link>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Struktur</a>
            <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Program</a>
            <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Sejarah</a>
